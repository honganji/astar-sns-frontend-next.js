  ...
  return (
    <div className="flex justify-center items-center bg-gray-200 w-screen h-screen relative">
      ...
      <main className="items-center h-screen w-1/3 justify-start flex bg-[#0090CD] flex-col">
        ...
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -top-20 left-[600px]"></div>
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute top-1/4 right-[550px]"></div>
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -bottom-20 left-[600px]"></div>
