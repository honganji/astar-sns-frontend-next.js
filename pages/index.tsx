  ...
  return (
    <div className="flex justify-center items-center bg-gray-200 w-screen h-screen relative">
      ...
      <main className="items-center h-screen w-1/3 justify-start flex bg-[#0090CD] flex-col">
        <p className="z-10 h-screen w-1/3 bg-white absolute top-0 left-0"></p>
        <p className="z-10 h-screen w-1/3 bg-white absolute top-0 right-0"></p>
        <p className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -top-24 left-[340px]"></p>
        <p className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute top-1/4 right-[300px]"></p>
        <p className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -bottom-24 left-[330px]"></p>
        <h1 className="z-10 text-[#0009DC] mt-24" style={{ fontSize: 57 }}>
          ASTAR SNS
        </h1>
        <p className="flex-row flex items-center mb-11 mt-7">
          <Image
        ...
        <p className="z-10 mt-16 mb-16 text-3xl items-center flex flex-col text-[#0009DC]">
          <p>SHARE YOUR</p>
          <p>WONDERFUL DAILY LIFE</p>
          <p>ON ASTAR</p>
        </p>
        <button
